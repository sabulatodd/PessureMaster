...
struct RootType: CreatableFromJSON { // TODO: Rename this struct
    ...
    init?(json: [String: Any]) {
        guard let patientSummary = PatientSummary.createRequiredInstances(from: json, arrayKey: "Patient_Summary") else { return nil }
        self.init(patientSummary: patientSummary)
    }
    struct PatientSummary: CreatableFromJSON { // TODO: Rename this struct
        let ageSex: String
        ...
        init(ageSex: String, isBeingEdited: Bool, mRN: String, patName: String, roomBed: String, surveyID: Int, surveyStatus: String) {
            self.ageSex = ageSex
        ...
        init?(json: [String: Any]) {
            ...
            guard let surveyStatus = json["Survey_Status"] as? String else { return nil }
            self.init(ageSex: ageSex, isBeingEdited: isBeingEdited, mRN: mRN, patName: patName, roomBed: roomBed, surveyID: surveyID, surveyStatus: surveyStatus)
        }
    }
}

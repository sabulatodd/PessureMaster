...
struct RootType: CreatableFromJSON { // TODO: Rename this struct
    ...
    init?(json: [String: Any]) {
        guard let unitInfo = UnitInfo.createRequiredInstances(from: json, arrayKey: "UnitInfo") else { return nil }
        self.init(unitInfo: unitInfo)
    }
    struct UnitInfo: CreatableFromJSON { // TODO: Rename this struct
        let unitDataID: Int
        let unitName: String
        init(unitDataID: Int, unitName: String) {
            self.unitDataID = unitDataID
            self.unitName = unitName
        }
        init?(json: [String: Any]) {
            guard let unitDataID = json["Unit_Data_ID"] as? Int else { return nil }
            guard let unitName = json["Unit_Name"] as? String else { return nil }
            self.init(unitDataID: unitDataID, unitName: unitName)
        }
    }
}
